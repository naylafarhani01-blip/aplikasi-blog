...
<div class="page-header">
    <div class="page-title">Edit Penulis <small>Ubah data penulis</small></div>
...
<div style="max-width:600px;">
    <div style="background:rgba(15,32,39,0.6); border:0.5px solid rgba(79,255,123,0.18); border-radius:12px; padding:28px;">
        <form action="{{ route('penulis.update', $penulis->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_depan" placeholder="Nama depan..."
                        ...
                        class="{{ $errors->has('nama_depan') ? 'is-invalid' : '' }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_belakang" placeholder="Nama belakang..."
                        ...
                        class="{{ $errors->has('nama_belakang') ? 'is-invalid' : '' }}">
            ...
            <div class="form-group">
                <label>Password Baru <small>(kosongkan jika tidak diubah, min. 8 karakter)</small></label>
            ...
            <div class="form-group">
                <label>Foto Profil <small>(kosongkan jika tidak diubah)</small></label>
                ...
                <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
                    <label class="file-label" for="foto"><i class="bi bi-image"></i> Ganti Foto</label>
